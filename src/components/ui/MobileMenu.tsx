...
const MobileMenu = ({ isOpenMobileMenu, onOpenMobileMenu, onOpenAboutMeModal }: MobileMenuProps) => {
    return (
        <div className={`md:hidden ${isOpenMobileMenu ? 'w-full' : 'w-0'} transition-all rounded-lg overflow-hidden white-space-nowrap flex items-center justify-between transition-all absolute h-12 bg-Gold`}>
